...
ggsave(venn.plt,
       file = file.path("..","figures_raw", "FigSXX_Microbiome.internalRxnsVenn.woCorrection.pdf"),
       width = 6.5, height = 3)
...
ggsave(plt.all,
       file = file.path("..","figures_raw","Fig1_EnrichedPathwaysMicrobeRxn.woCorrection.pdf"),
       height = x,
       width = 5)
