...
stats <- fread("../results/FVA.GLMM.Remission.biomarker_coefs.csv")
...
# don't do it anymore, because of problems downstream
...
# save the results
write.csv(stab, file = "../results/PA.GSEA.Remission.biomarker_GSEAstabilityAnalysis.csv")
write.csv(as.data.frame(estimates.all), file = "../results/PA.GSEA.Remission.biomarker_rankingVector.csv")
saveRDS(gsea, file = "../results/PA.GSEA.Remission.biomarker_GSEAResult.RDS") 
