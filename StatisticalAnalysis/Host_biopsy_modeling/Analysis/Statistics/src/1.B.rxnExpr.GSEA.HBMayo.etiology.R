...
stats <- fread("../results/rxnExpr.LMM.HBMayo.etiology_coefs.csv")
...
# save the results
write.csv(stab, file = "../results/rxnExpr.GSEA.HBMayo.etiology_GSEAstabilityAnalysis.csv")
write.csv(as.data.frame(estimates.all), file = "../results/rxnExpr.GSEA.HBMayo.etiology_rankingVector.csv")
saveRDS(gsea, file = "../results/rxnExpr.GSEA.HBMayo.etiology_GSEAResult.RDS")
