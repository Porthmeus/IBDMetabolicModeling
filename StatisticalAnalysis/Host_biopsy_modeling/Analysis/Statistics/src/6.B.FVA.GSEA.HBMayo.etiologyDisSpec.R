...
stats <- fread("../results/FVA.LMM.HBMayo.etiologyDisSpec_coefs.csv")
...
# save the results
write.csv(stab, file = "../results/FVA.GSEA.HBMayo.etiologyDisSpec_stabilityAnalysis.csv")
write.csv(as.data.frame(estimates.all), file = "../results/FVA.GSEA.HBMayo.etiologyDisSpec_rankingVector.csv")
saveRDS(gsea, file = "../results/FVA.GSEA.HBMayo.etiologyDisSpec_GSEAResult.RDS")
