...
stats <- fread("../results/FVA.GLMM.Response.biomarker_coefs.csv")
...
# save the results
write.csv(stab, file = "../results/PA.GSEA.Response.biomarker_GSEAstabilityAnalysis.csv")
write.csv(as.data.frame(estimates.all), file = "../results/PA.GSEA.Response.biomarker_rankingVector.csv")
saveRDS(gsea, file = "../results/PA.GSEA.Response.biomarker_GSEAResult.RDS") 
