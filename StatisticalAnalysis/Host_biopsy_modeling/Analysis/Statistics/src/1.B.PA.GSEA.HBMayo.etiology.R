...
stats <- fread("../results/PA.LMM.HBMayo.etiology_coefs.csv")
...
# save the results
write.csv(stab, file = "../results/PA.GSEA.HBMayo.etiology_GSEAstabilityAnalysis.csv")
write.csv(as.data.frame(estimates.all), file = "../results/PA.GSEA.HBMayo.etiology_rankingVector.csv")
saveRDS(gsea, file = "../results/PA.GSEA.HBMayo.etiology_GSEAResult.RDS")
