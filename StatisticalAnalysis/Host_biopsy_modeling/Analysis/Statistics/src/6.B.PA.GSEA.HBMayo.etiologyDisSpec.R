...
stats <- fread("../results/PA.LMM.HBMayo.etiologyDisSpec_coefs.csv")
...
# save the results
write.csv(stab, file = "../results/PA.GSEA.HBMayo.etiologyDisSpec_GSEAstabilityAnalysis.csv")
write.csv(as.data.frame(estimates.all), file = "../results/PA.GSEA.HBMayo.etiologyDisSpec_rankingVector.csv")
saveRDS(gsea, file = "../results/PA.GSEA.HBMayo.etiologyDisSpec_GSEAResult.RDS")
