...
# save the results
write.csv(stab, file = "../results/FVA.GSEA.Response.biomarker_stabilityAnalysis.csv")
write.csv(as.data.frame(estimates.all), file = "../results/FVA.GSEA.Response.biomarker_rankingVector.csv")
saveRDS(gsea, file = "../results/FVA.GSEA.Response.biomarker_GSEAResult.RDS")
