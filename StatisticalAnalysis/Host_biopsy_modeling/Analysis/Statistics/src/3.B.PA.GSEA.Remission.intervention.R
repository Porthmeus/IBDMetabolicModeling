...
stats <- fread("../results/PA.GLMM.Remission.intervention_coefs.csv")
...
## don't do this anymore, cause it troubles downstream
...
# save the results
write.csv(stab, file = "../results/PA.GSEA.Remission.intervention_stabilityAnalysis.csv")
write.csv(as.data.frame(estimates.all), file = "../results/PA.GSEA.Remission.intervention_rankingVector.csv")
saveRDS(gsea, file = "../results/PA.GSEA.Remission.intervention_GSEAResult.RDS")
