...
stats <- fread("../results/rxnExpr.GLMM.Response.biomarker_coefs.csv")
...
# save the results
write.csv(stab, file = "../results/rxnExpr.GSEA.Response.biomarker_stabilityAnalysis.csv")
write.csv(as.data.frame(estimates.all), file = "../results/rxnExpr.GSEA.Response.biomarker_rankingVector.csv")
saveRDS(gsea, file = "../results/rxnExpr.GSEA.Response.biomarker_GSEAResult.RDS")
