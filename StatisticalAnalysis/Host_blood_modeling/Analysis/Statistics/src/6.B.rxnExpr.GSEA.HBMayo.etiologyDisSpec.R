...
stats <- fread("../results/rxnExpr.LMM.HBMayo.etiologyDisSpec_coefs.csv")
...
# save the results
write.csv(stab, file = "../results/rxnExpr.GSEA.HBMayo.etiologyDisSpec_GSEAstabilityAnalysis.csv")
write.csv(as.data.frame(estimates.all), file = "../results/rxnExpr.GSEA.HBMayo.etiologyDisSpec_rankingVector.csv")
saveRDS(gsea, file = "../results/rxnExpr.GSEA.HBMayo.etiologyDisSpec_GSEAResult.RDS")
