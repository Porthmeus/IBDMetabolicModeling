...
names(mods) <- rxns
saveRDS(mods, file = "../results/PA.GLMM.Remission.biomarker_models.RDS")
...
write.csv(stats, row.names=FALSE, file = "../results/PA.GLMM.Remission.biomarker_coefs.csv")
...
i<-0
pdf("../results/PA.GLMM.Remission.biomarker_sigDiagPlots.pdf")
for(rxn in rxns.sig){
