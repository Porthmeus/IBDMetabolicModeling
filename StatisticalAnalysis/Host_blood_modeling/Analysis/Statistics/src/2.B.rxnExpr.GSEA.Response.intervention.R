...
stats <- fread("../results/rxnExpr.GLMM.Response.intervention_coefs.csv")
...
## don't do it anymore, because it causes problems in the downstream analysis
...
# save the results
write.csv(stab, file = "../results/rxnExpr.GSEA.Response.intervention_GSEAstabilityAnalysis.csv")
write.csv(as.data.frame(estimates.all), file = "../results/rxnExpr.GSEA.Response.intervention_rankingVector.csv")
saveRDS(gsea, file = "../results/rxnExpr.GSEA.Response_GSEASubsystems.RDS")
