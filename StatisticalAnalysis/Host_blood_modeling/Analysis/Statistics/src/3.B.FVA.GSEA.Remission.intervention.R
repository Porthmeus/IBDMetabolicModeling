...
stats <- fread("../results/FVA.GLMM.Remission.intervention_coefs.csv")
...
# save the results
write.csv(stab, file = "../results/FVA.GSEA.Remission.intervention_stabilityAnalysis.csv")
write.csv(as.data.frame(estimates.all), file = "../results/FVA.GSEA.Remission.intervention_rankingVector.csv")
saveRDS(gsea, file = "../results/FVA.GSEA.Remission.intervention_GSEAResult.RDS")
