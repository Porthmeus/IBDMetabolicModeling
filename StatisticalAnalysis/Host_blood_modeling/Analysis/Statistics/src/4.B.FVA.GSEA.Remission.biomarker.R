...
## don't do it anymore, causes problems in the GSEA
...
# save the results
write.csv(stab, file = "../results/FVA.GSEA.Remission.biomarker_stabilityAnalysis.csv")
write.csv(as.data.frame(estimates.all), file = "../results/FVA.GSEA.Remission.biomarker_rankingVector.csv")
saveRDS(gsea, file = "../results/FVA.GSEA.Remission.biomarker_GSEAResult.RDS")
