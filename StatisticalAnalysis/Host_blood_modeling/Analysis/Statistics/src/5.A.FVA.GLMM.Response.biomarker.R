...
names(mods) <- rxns
saveRDS(mods, file = "../results/FVA.GLMM.Response.biomarker_models.RDS")
...
write.csv(stats, row.names=FALSE, file = "../results/FVA.GLMM.Response.biomarker_coefs.csv")
...
i<-0
pdf("../results/FVA.GLMM.Response.biomarker_sigDiagPlots.pdf")
for(rxn in rxns.sig){
