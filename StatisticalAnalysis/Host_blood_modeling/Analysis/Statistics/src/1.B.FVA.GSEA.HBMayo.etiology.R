...
stats <- fread("../results/FVA.LMM.HBMayo.etiology_coefs.csv")
...
# save the results
write.csv(stab, file = "../results/FVA.GSEA.HBMayo.etiology_stabilityAnalysis.csv")
write.csv(as.data.frame(estimates.all), file = "../results/FVA.GSEA.HBMayo.etiology_rankingVector.csv")
saveRDS(gsea, file = "../results/FVA.GSEA.HBMayo.etiology_GSEAResult.RDS")
