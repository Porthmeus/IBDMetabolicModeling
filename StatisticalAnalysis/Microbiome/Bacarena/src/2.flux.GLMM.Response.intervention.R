...
mods <- mods[!sel]
saveRDS(mods, file = "../results/flux.GLMM.Response.intervention_mods.RDS")
...
write.csv(file = "../results/flux.GLMM.Response.intervention_coefs.csv", stats.coef, row.names = FALSE)
